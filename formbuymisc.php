...
<body>
  <div class="container">
    ...
    <form class="well form-horizontal" action="buymisc.php" method="get"  id="contact_form">
<fieldset>
...
<div class="form-group">
  ...
  <input hidden name="bookid" value="<?php echo $_GET['id'] ?>"/>
    </div>
  </div>
</div>
...
<div class="form-group">
  ...
  <input name="phone" placeholder="+91xxxxxxxxxx" class="form-control" type="text" required>
    </div>
  </div>
</div>
